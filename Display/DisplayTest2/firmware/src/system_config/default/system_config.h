...
#define DISP_DATA_SETUP_WAIT        PMP_DATA_WAIT_ONE //PMP_DATA_WAIT_TWO
#define DISP_STROBE_WAIT_STATES     PMP_STROBE_WAIT_2
#define DISP_DATA_HOLD_WAIT_STATES  PMP_DATA_HOLD_2 //PMP_DATA_HOLD_1 /* one has an errata that causes no interrupts */
