...
//
// Had to re-write as not all Wi-Fire LEDs on same port so Original Harmony code does not work
//
//#############################################################################
...
// ---- ChipKit Wi-Fire LED Locations ------
// LED1 G6
// LED2 D4
// LED3 B11
// LED4 G15
#define BSP_LED_1_PORT   PORT_CHANNEL_G
#define BSP_LED_2_PORT   PORT_CHANNEL_D
#define BSP_LED_3_PORT   PORT_CHANNEL_B
#define BSP_LED_4_PORT   PORT_CHANNEL_G
#define BSP_LED_1_BIT_POS PORTS_BIT_POS_6
#define BSP_LED_2_BIT_POS PORTS_BIT_POS_4
#define BSP_LED_3_BIT_POS PORTS_BIT_POS_11
#define BSP_LED_4_BIT_POS PORTS_BIT_POS_15
#define BSP_LED_1_AN        PORTS_ANALOG_PIN_14
//#define BSP_LED_2_AN        /* not an analog pin */
#define BSP_LED_3_AN        PORTS_ANALOG_PIN_6
#define BSP_LED_4_AN        PORTS_ANALOG_PIN_23

// ---- ChipKit Wi-Fire Button Locations -----

// BTN1 A5
// BTN2 A4
#define BSP_BTN_PORT   PORT_CHANNEL_A
#define BSP_BTN_1_BIT_POS PORTS_BIT_POS_5
#define BSP_BTN_2_BIT_POS PORTS_BIT_POS_4
//--------------------------------------------
...
{
    /* SWITCH 1 */
     BSP_SWITCH_1 = /*DOM-IGNORE-BEGIN*/BSP_BTN_1_BIT_POS/*DOM-IGNORE-END*/,

    /* SWITCH 2 */
     BSP_SWITCH_2 = /*DOM-IGNORE-BEGIN*/BSP_BTN_2_BIT_POS/*DOM-IGNORE-END*/
...
{
    /* LED 1 on SK */
    BSP_LED_1 = /*DOM-IGNORE-BEGIN*/BSP_LED_1_BIT_POS/*DOM-IGNORE-END*/,

    /* LED 2 on SK */
    BSP_LED_2 = /*DOM-IGNORE-BEGIN*/BSP_LED_2_BIT_POS/*DOM-IGNORE-END*/,

    /* LED 3 on SK */
    BSP_LED_3 = /*DOM-IGNORE-BEGIN*/BSP_LED_3_BIT_POS/*DOM-IGNORE-END*/,

    /* LED 3 on SK */
    BSP_LED_4 = /*DOM-IGNORE-BEGIN*/BSP_LED_4_BIT_POS/*DOM-IGNORE-END*/
