// <editor-fold defaultstate="collapsed" desc="Header/SLA">
/*******************************************************************************
  ...
  Summary:      
    Board Support Package Header file for chipKIT Wi-FIRE.

  Description:
    This file contains constants, macros, type definitions and function
    declarations required by the chipKIT Wi-FIRE BSP. 
 *******************************************************************************/
...
#define BSP_LED_1_CHANNEL   PORT_CHANNEL_G
#define BSP_LED_2_CHANNEL   PORT_CHANNEL_B
#define BSP_LED_3_CHANNEL   PORT_CHANNEL_D
#define BSP_LED_4_CHANNEL   PORT_CHANNEL_G
...
{
    /* SWITCH 2 */
     BSP_SWITCH_1 = PORTS_BIT_POS_5,

    /* SWITCH 3 */
     BSP_SWITCH_2 = PORTS_BIT_POS_4,
...
{
    /* Switch pressed */
    BSP_SWITCH_STATE_PRESSED = 1,

   /* Switch not pressed */
    BSP_SWITCH_STATE_RELEASED = 0
...
{
    /* LED 1 */
    BSP_LED_1 = PORTS_BIT_POS_6,

    /* LED 2 */
    BSP_LED_2 = PORTS_BIT_POS_4,

    /* LED 3 */
    BSP_LED_3 = PORTS_BIT_POS_11,
	
    /* LED 4 */
    BSP_LED_4 = PORTS_BIT_POS_15,
