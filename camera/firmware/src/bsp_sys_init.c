...
/*******************************************************************************
  ...
  Description:
    This file contains routines that implement the board support      
    package for chipKIT Wi-FIRE.
 *******************************************************************************/
...
void BSP_Initialize(void )
{
    ...
    SYS_PORTS_PinDirectionSelect(0,SYS_PORTS_DIRECTION_OUTPUT, BSP_LED_1_CHANNEL,BSP_LED_1);
    SYS_PORTS_PinDirectionSelect(0,SYS_PORTS_DIRECTION_OUTPUT, BSP_LED_2_CHANNEL,BSP_LED_2);
    SYS_PORTS_PinDirectionSelect(0,SYS_PORTS_DIRECTION_OUTPUT, BSP_LED_3_CHANNEL,BSP_LED_3);
    SYS_PORTS_PinDirectionSelect(0,SYS_PORTS_DIRECTION_OUTPUT, BSP_LED_4_CHANNEL,BSP_LED_4);
